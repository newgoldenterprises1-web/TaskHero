...
- `customer/js/navigation.js` = screen navigation and search focus
- `customer/js/services.js` = categories, service browsing and service details
...
- `customer/js/location.js` = device/manual location and persisted location label
